    ...
    <div className="w-full bg-white p-6 rounded-xl shadow-lg">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-2 rounded-xl shadow-lg border border-purple-300 flex flex-col">
          ...
          <h3 className="relative pb-2 mt-4 pl-4 text-lg font-semibold">Pie Chart Spread</h3>
          ...
          {(totalIncome === 0 && totalExpense === 0 && balance === 0) ? (
            ...
            <div className="w-full h-94 mt-6 bg-white flex items-center justify-center">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-blue-300 p-4">
          ...
          {/* Show empty-state ONLY inside this card */}
